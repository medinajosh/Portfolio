...
const About = () => {
  ...
  useEffect(() => {
    setShowAnimation(true); // Trigger animation when the component is rendered
  }, []);

  return (
    <section
      id="about" // Make sure this matches the Link target in the Navbar
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-6">
        ...
        <div className="text-center md:text-left md:w-1/2 md:pl-16 space-y-6">
          <h2
            className={`text-5xl font-extrabold text-white mb-4 leading-tight ${
              showAnimation ? "animate__animated animate__fadeIn animate__delay-1s" : ""
            }`}
          >
            About Me
          </h2>
          <p
            className={`text-lg text-gray-200 leading-relaxed mb-4 ${
              showAnimation ? "animate__animated animate__fadeIn animate__delay-2s" : ""
            }`}
          >
          ...
          <p
            className={`text-lg text-gray-200 leading-relaxed mb-6 ${
              showAnimation ? "animate__animated animate__fadeIn animate__delay-3s" : ""
            }`}
          >
